...
public class UAMConfigGroup extends ReflectiveConfigGroup {
	...
	static public final String MAX_POOLING_WAIT_TIME = "maxPoolingWaitTime";
	...
	static private final String MAX_POOLING_WAIT_TIME_EXP = "Maximum time in seconds that the oldest compatible passenger request waits for a pooled aircraft to fill";
	...
	@PositiveOrZero
	private double maxPoolingWaitTime = 300.0;
	...
	public Map<String, String> getComments() {
		...
		map.put(MAX_POOLING_WAIT_TIME, MAX_POOLING_WAIT_TIME_EXP);
		return map;
	}
	...
	@StringGetter(MAX_POOLING_WAIT_TIME)
	public double getMaxPoolingWaitTime() {
		return maxPoolingWaitTime;
	}

	@StringSetter(MAX_POOLING_WAIT_TIME)
	public void setMaxPoolingWaitTime(double maxPoolingWaitTime) {
