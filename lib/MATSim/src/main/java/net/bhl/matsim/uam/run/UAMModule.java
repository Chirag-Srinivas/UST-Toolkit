...
import net.bhl.matsim.uam.scoring.UAMPostBoardingQueueTracker;
import net.bhl.matsim.uam.scoring.UAMPreBoardingWaitTracker;
import net.bhl.matsim.uam.scoring.UAMScoringFunctionFactory;
import net.bhl.matsim.uam.scoring.UAMVertiportActivityWaitTracker;
...
public class UAMModule extends AbstractDvrpModeModule {
	...
	public void install() {
		...
		bind(UAMPreBoardingWaitTracker.class).asEagerSingleton();
		addEventHandlerBinding().to(UAMPreBoardingWaitTracker.class);
		bind(UAMPostBoardingQueueTracker.class).asEagerSingleton();
		addEventHandlerBinding().to(UAMPostBoardingQueueTracker.class);
		bind(UAMVertiportActivityWaitTracker.class).asEagerSingleton();
		addEventHandlerBinding().to(UAMVertiportActivityWaitTracker.class);
